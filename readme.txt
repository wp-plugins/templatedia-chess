...
Go to the admin area of your WordPress install and click on the "Plugins" menu. Click on "Activate" for the "Templatedia Chess" plugin.
...
I'm a very busy guy, so please use the [official WordPress support forums](http://wordpress.org/tags/templatedia-chess#postform) for help (post it in the "Plugins and Hacks" section). By posting there, you will easily be able to get support from both me as well other WordPress users.
...
1. Example of the template's output, displaying the beginning of a chess game
2. Example of the template's output, displaying a chess problem
3. Example of the template syntax, in this case displaying the code for screenshot #2
